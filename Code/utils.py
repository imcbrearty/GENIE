...
def visualize_predictions(ind, ext_save, depth_window = 10e3, deg_window = 1.0, thresh_source = 0.2, thresh_picks = 0.2, n_ver = 1, close_plots = True):
	...
	if raw_picks == True:
		...
		fig.savefig(ext_save + 'raw_picks_%d_ver_%d.png'%(ind, n_ver), bbox_inches = 'tight', pad_inches = 0.2)
	...
	if raw_picks_permuted == True:
		...
		fig.savefig(ext_save + 'raw_picks_sorted_%d_ver_%d.png'%(ind, n_ver), bbox_inches = 'tight', pad_inches = 0.2)
	...
	if map_view_all_depths == True:
		...
		fig.savefig(ext_save + 'map_view_all_depths_%d_ver_%d.png'%(ind, n_ver), bbox_inches = 'tight', pad_inches = 0.2)
	...
	if map_view_associated_stations == True:
		...
		fig.savefig(ext_save + 'map_view_associated_phases_%d_ver_%d.png'%(ind, n_ver), bbox_inches = 'tight', pad_inches = 0.2)
