...
if compute_magnitudes == True:
	...
	try:
		n_mag_ver = 1
		mags_supp = np.load(path_to_file + seperator + 'Grids' + seperator + 'trained_magnitude_model_ver_%d_supplemental.npz'%n_mag_ver)
		...
		mags.load_state_dict(torch.load(path_to_file + seperator + 'Grids' + seperator + 'trained_magnitude_model_ver_%d.hdf5'%n_mag_ver, map_location = device))
